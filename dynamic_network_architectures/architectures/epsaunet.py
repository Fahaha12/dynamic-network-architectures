...
class EPSAPlainConvUNet(nn.Module):
    def __init__(self,
                 input_channels: int,
                 n_stages: int,
    ...
    def __init__(self,
        ...
        for s in range(n_stages):
            ...
            if pool == 'max' or pool == 'avg':
                ...
                raise RuntimeError()
            stage_modules.append(EPSAStackedConvBlocks(
...
class UNetDecoder(nn.Module):
    def __init__(self,
        ...
        for s in range(1, n_stages_encoder):
            ...
            stages.append(EPSAStackedConvBlocks(
...
class EPSAStackedConvBlocks(nn.Module):
    def __init__(self,
                 num_convs: int,
                 conv_op: Type[_ConvNd],
                 input_channels: int,
...
class EPSAConvDropoutNormReLU(nn.Module):
    def __init__(self,
                 conv_op: Type[_ConvNd],
                 input_channels: int,
                 output_channels: int,
        ...
        super(EPSAConvDropoutNormReLU, self).__init__()
        self.input_channels = input_channels
        self.output_channels = output_channels
        stride = maybe_convert_scalar_to_list(conv_op, stride)
        self.stride = stride
        ...
        ops = []
        if input_channels < 16 or output_channels < 64:
            self.conv = conv_op(
                input_channels,
                output_channels,
                kernel_size,
            ...
            self.conv = PSAModule(conv_op, input_channels, output_channels)
            print('using epsamodule...')
...
class PSAModule(nn.Module):
    ...
    def __init__(self, conv_op, inplans, planes, conv_kernels=[3, 5, 7, 9], stride=1, conv_groups=[1, 2, 4, 8]):
        ...
        if conv_op == torch.nn.modules.conv.Conv2d:
            ...
            self.se = SEWeightModule2d(planes // 4)
...
class SEWeightModule2d(nn.Module):
 
    def __init__(self, channels, reduction=16):
        super(SEWeightModule2d, self).__init__()
